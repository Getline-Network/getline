  ...
  <div class="loan-list">
    ...
    <div v-else class="ll-container">
        <md-table md-sort="procent-needed">
          ...
          <md-table-body>
            <md-table-row v-for="loan in loans">
...
.loan-list { width: calc(100% - 200px); min-width: 570px; margin: 0 auto;
  ...
  .ll-container { margin-bottom: 40px; border-radius: 2px; background-color: #ffffff; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.02);
    table.table { width: 100%;
      th { height: 44px; font-size: 11px; font-weight: 300; text-align: left; letter-spacing: 0.4px; color: #858585; border-bottom: 1px solid var(--color-white-smoke); }
      td { height: 66px; text-align: left; border-bottom: 1px solid var(--color-white-smoke); }
      tr { margin-left: 10px; }
    }
    ...
    .ll-td { height: 66px; font-size: 12px; text-align: left; color: #1c1c1c; border-bottom: 1px solid var(--color-white-smoke);
